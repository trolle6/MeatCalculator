...
app.MapGet("/api/data", () => new
{
    ...
    constants = new
    {
        ...
        weightLossSliderMin = BrisketData.WeightLossSliderMin,
        weightLossSliderMax = BrisketData.WeightLossSliderMax,
        weightLossTypicalMin = BrisketData.WeightLossMin,
        weightLossTypicalMax = BrisketData.WeightLossMaxJuicy,
