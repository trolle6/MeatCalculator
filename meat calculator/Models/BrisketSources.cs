...

{
    ...
    public const string Intro =
        ...
        "Smoke Lab - BBQ is a community planning tool. Ideas below come from public brisket teaching (mainly Steve Gow / Smoke Trails BBQ). Not affiliated with or endorsed by the channel.";
